...
formRouter.get('/:firstname/:lastname/:password/:iscool/:age', formCheck, (req, res)=>{
    ...
    res.status(200).json({firstname: firstname, lastname: lastname, password: password, iscool: iscool, age: age})
})
